...
class CreateNotificationInFolderView extends StatefulWidget {
  const CreateNotificationInFolderView({Key? key, required this.folder})
      : super(key: key);

  static const routeName = 'create_notification_in_folder_view';

  final NotifyFolderQuick folder;

  @override
  State<CreateNotificationInFolderView> createState() =>
      _CreateNotificationInFolderViewState();
}

class _CreateNotificationInFolderViewState
    extends State<CreateNotificationInFolderView> {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          try {
            final NotifyNotificationDetailed ntf =
            ...
            await ApiService.folders.addNotification(
